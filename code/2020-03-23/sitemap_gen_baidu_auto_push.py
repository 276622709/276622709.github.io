...
def main():
    ...
    return 0
#end def
curloption='curl -H "Content-Type:text/plain" --data-binary @urls.txt "http://data.zz.baidu.com/urls?site=https://www.zmy024.cn&token=kQzQvCq5EIljjE4x"'
if __name__ == '__main__':
    try:
        status_code = main()
    except KeyboardInterrupt:
        status_code = 130
    (value,bak)=subprocess.getstatusoutput(curloption)
    print(bak)
